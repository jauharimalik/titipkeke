...
?>
	...
	$result = mysql_query($que);
								...
								?>	
								<tr>
									<td><a class="btn btn-block btn-primary btn-sm" href="<?php echo $c_url."/pkimle/deploy2/tom-".$kode_per ?>"><i class="fa fa-edit"></i> Edit</a></td>								
									<td><?php echo $data['kd_permohonan']; ?></td>
